...
def run_pytest(parallel=False):
    ...
    cmd = ["pytest", ui_tests_path, f"--html={reports_dir}/report.html"]
    ...
    if parallel:
        ...
        cmd = ["pytest", ui_tests_path, "-m", "serial", f"--html={reports_dir}/report_serial.html"]
    else:
        cmd = ["pytest", ui_tests_path, f"--html={reports_dir}/report_serial.html"]
